...
function buildF1m(module, _q, _prefix, _intPrefix) {
	...
	function buildMul() {
		...
		const np32 = Number(4294967296n - modInv(q, 4294967296n));
		const qLimbs = [];
		for (let j = 0; j < n32; j++) qLimbs.push(Number(q >> BigInt(32 * j) & 4294967295n));
		const MASK32 = 4294967295;
		const noCarry = q < 1n << BigInt(32 * n32 - 1);
		for (let i = 0; i < n32; i++) f.addCode(c.setLocal("x" + i, c.i64_load32_u(c.getLocal("x"), i * 4)));
		for (let i = 0; i < n32; i++) {
			f.addCode(c.setLocal("yi", c.i64_load32_u(c.getLocal("y"), i * 4)));
			f.addCode(c.setLocal("s", c.i64_add(c.getLocal("t0"), c.i64_mul(c.getLocal("x0"), c.getLocal("yi")))), c.setLocal("t0", c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("cc", c.i64_shr_u(c.getLocal("s"), c.i64_const(32))));
			for (let j = 1; j < n32; j++) f.addCode(c.setLocal("s", c.i64_add(c.i64_add(c.getLocal("t" + j), c.i64_mul(c.getLocal("x" + j), c.getLocal("yi"))), c.getLocal("cc"))), c.setLocal("t" + j, c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("cc", c.i64_shr_u(c.getLocal("s"), c.i64_const(32))));
			if (noCarry) f.addCode(c.setLocal("t" + n32, c.getLocal("cc")));
			else f.addCode(c.setLocal("s", c.i64_add(c.getLocal("t" + n32), c.getLocal("cc"))), c.setLocal("t" + n32, c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("t" + (n32 + 1), c.i64_add(c.getLocal("t" + (n32 + 1)), c.i64_shr_u(c.getLocal("s"), c.i64_const(32)))));
			f.addCode(c.setLocal("m", c.i64_and(c.i64_mul(c.getLocal("t0"), c.i64_const(np32)), c.i64_const(MASK32))), c.setLocal("s", c.i64_add(c.getLocal("t0"), c.i64_mul(c.getLocal("m"), c.i64_const(qLimbs[0])))), c.setLocal("cc", c.i64_shr_u(c.getLocal("s"), c.i64_const(32))));
			for (let j = 1; j < n32; j++) f.addCode(c.setLocal("s", c.i64_add(c.i64_add(c.getLocal("t" + j), c.i64_mul(c.getLocal("m"), c.i64_const(qLimbs[j]))), c.getLocal("cc"))), c.setLocal("t" + (j - 1), c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("cc", c.i64_shr_u(c.getLocal("s"), c.i64_const(32))));
			if (noCarry) f.addCode(c.setLocal("t" + (n32 - 1), c.i64_add(c.getLocal("t" + n32), c.getLocal("cc"))));
			else f.addCode(c.setLocal("s", c.i64_add(c.getLocal("t" + n32), c.getLocal("cc"))), c.setLocal("t" + (n32 - 1), c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("t" + n32, c.i64_add(c.getLocal("t" + (n32 + 1)), c.i64_shr_u(c.getLocal("s"), c.i64_const(32)))), c.setLocal("t" + (n32 + 1), c.i64_const(0)));
		}
		for (let j = 0; j < n32; j++) f.addCode(c.i64_store32(c.getLocal("r"), j * 4, c.getLocal("t" + j)));
		if (noCarry) f.addCode(c.if(c.call(intPrefix + "_gte", c.getLocal("r"), c.i32_const(pq)), c.drop(c.call(intPrefix + "_sub", c.getLocal("r"), c.i32_const(pq), c.getLocal("r")))));
		else f.addCode(c.if(c.i32_wrap_i64(c.getLocal("t" + n32)), c.drop(c.call(intPrefix + "_sub", c.getLocal("r"), c.i32_const(pq), c.getLocal("r"))), c.if(c.call(intPrefix + "_gte", c.getLocal("r"), c.i32_const(pq)), c.drop(c.call(intPrefix + "_sub", c.getLocal("r"), c.i32_const(pq), c.getLocal("r"))))));
	}
	function buildSquare() {
		const f = module.addFunction(prefix + "_square");
		f.addParam("x", "i32");
		...
		for (let i = 0; i < n32; i++) f.addCode(c.setLocal("x" + i, c.i64_load32_u(c.getLocal("x"), i * 4)));
		for (let i = 0; i < n32; i++) {
			f.addCode(c.setLocal("s", c.i64_add(c.getLocal("t" + i), c.i64_mul(c.getLocal("x" + i), c.getLocal("x" + i)))), c.setLocal("t" + i, c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("cc", c.i64_shr_u(c.getLocal("s"), c.i64_const(32))));
			for (let j = i + 1; j < n32; j++) f.addCode(c.setLocal("p", c.i64_mul(c.getLocal("x" + j), c.getLocal("x" + i))), c.setLocal("s", c.i64_add(c.i64_add(c.getLocal("t" + j), c.i64_shl(c.i64_and(c.getLocal("p"), c.i64_const(MASK32)), c.i64_const(1))), c.getLocal("cc"))), c.setLocal("t" + j, c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("cc", c.i64_add(c.i64_shr_u(c.getLocal("s"), c.i64_const(32)), c.i64_shl(c.i64_shr_u(c.getLocal("p"), c.i64_const(32)), c.i64_const(1)))));
			f.addCode(c.setLocal("s", c.i64_add(c.getLocal("t" + n32), c.getLocal("cc"))), c.setLocal("t" + n32, c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("t" + (n32 + 1), c.i64_add(c.getLocal("t" + (n32 + 1)), c.i64_shr_u(c.getLocal("s"), c.i64_const(32)))));
			f.addCode(c.setLocal("m", c.i64_and(c.i64_mul(c.getLocal("t0"), c.i64_const(np32)), c.i64_const(MASK32))), c.setLocal("s", c.i64_add(c.getLocal("t0"), c.i64_mul(c.getLocal("m"), c.i64_const(qLimbs[0])))), c.setLocal("cc", c.i64_shr_u(c.getLocal("s"), c.i64_const(32))));
			for (let j = 1; j < n32; j++) f.addCode(c.setLocal("s", c.i64_add(c.i64_add(c.getLocal("t" + j), c.i64_mul(c.getLocal("m"), c.i64_const(qLimbs[j]))), c.getLocal("cc"))), c.setLocal("t" + (j - 1), c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("cc", c.i64_shr_u(c.getLocal("s"), c.i64_const(32))));
			f.addCode(c.setLocal("s", c.i64_add(c.getLocal("t" + n32), c.getLocal("cc"))), c.setLocal("t" + (n32 - 1), c.i64_and(c.getLocal("s"), c.i64_const(MASK32))), c.setLocal("t" + n32, c.i64_add(c.getLocal("t" + (n32 + 1)), c.i64_shr_u(c.getLocal("s"), c.i64_const(32)))), c.setLocal("t" + (n32 + 1), c.i64_const(0)));
		}
		for (let j = 0; j < n32; j++) f.addCode(c.i64_store32(c.getLocal("r"), j * 4, c.getLocal("t" + j)));
		f.addCode(c.if(c.i32_wrap_i64(c.getLocal("t" + n32)), c.drop(c.call(intPrefix + "_sub", c.getLocal("r"), c.i32_const(pq), c.getLocal("r"))), c.if(c.call(intPrefix + "_gte", c.getLocal("r"), c.i32_const(pq)), c.drop(c.call(intPrefix + "_sub", c.getLocal("r"), c.i32_const(pq), c.getLocal("r"))))));
	}
	function buildSquareOld() {
		const f = module.addFunction(prefix + "_squareOld");
		f.addParam("x", "i32");
...
function buildMultiexp(module, prefix, fnName, opAdd, opSub, n8b) {
	...
	function buildRecode() {
		...
		const c = f.getCodeBuilder();
		f.addCode(c.setLocal("half", c.i32_shl(c.i32_const(1), c.i32_sub(c.getLocal("chunkSize"), c.i32_const(1)))), c.setLocal("scalarBits", c.i32_shl(c.getLocal("scalarSize"), c.i32_const(3))), c.setLocal("nWin", c.i32_add(c.getLocal("nChunks"), c.i32_const(1))), c.setLocal("itScalar", c.getLocal("pScalars")), c.setLocal("i", c.i32_const(0)), c.block(c.loop(c.br_if(1, c.i32_eq(c.getLocal("i"), c.getLocal("n"))), c.setLocal("carry", c.i32_const(0)), c.setLocal("j", c.i32_const(0)), c.block(c.loop(c.br_if(1, c.i32_eq(c.getLocal("j"), c.getLocal("nWin"))), c.i32_store8(c.i32_add(c.getLocal("pCarry"), c.i32_add(c.i32_mul(c.getLocal("j"), c.getLocal("n")), c.getLocal("i"))), c.getLocal("carry")), c.setLocal("startBit", c.i32_mul(c.getLocal("j"), c.getLocal("chunkSize"))), c.if(c.i32_lt_s(c.getLocal("startBit"), c.getLocal("scalarBits")), c.setLocal("raw", c.call(fnName + "_getChunk", c.getLocal("itScalar"), c.getLocal("scalarSize"), c.getLocal("startBit"), c.getLocal("chunkSize"))), c.setLocal("raw", c.i32_const(0))), c.if(c.i32_ge_s(c.i32_add(c.getLocal("raw"), c.getLocal("carry")), c.getLocal("half")), c.setLocal("carry", c.i32_const(1)), c.setLocal("carry", c.i32_const(0))), c.setLocal("j", c.i32_add(c.getLocal("j"), c.i32_const(1))), c.br(0))), c.setLocal("itScalar", c.i32_add(c.getLocal("itScalar"), c.getLocal("scalarSize"))), c.setLocal("i", c.i32_add(c.getLocal("i"), c.i32_const(1))), c.br(0))));
	}
	function buildMutiexpChunk() {
		...
		f.addLocal("itB", "i32");
		const c = f.getCodeBuilder();
		f.addCode(c.if(c.i32_eqz(c.getLocal("n")), [...c.call(prefix + "_zero", c.getLocal("pr")), ...c.ret([])]), c.setLocal("nTable", c.i32_shl(c.i32_const(1), c.i32_sub(c.getLocal("chunkSize"), c.i32_const(1)))), c.setLocal("full", c.i32_shl(c.i32_const(1), c.getLocal("chunkSize"))), c.setLocal("scalarBits", c.i32_shl(c.getLocal("scalarSize"), c.i32_const(3))), c.setLocal("startBit", c.i32_mul(c.getLocal("windowIdx"), c.getLocal("chunkSize"))), c.setLocal("pTable", c.i32_load(c.i32_const(0))), c.i32_store(c.i32_const(0), c.i32_add(c.getLocal("pTable"), c.i32_mul(c.getLocal("nTable"), c.i32_const(n8g)))), c.setLocal("j", c.i32_const(0)), c.block(c.loop(c.br_if(1, c.i32_eq(c.getLocal("j"), c.getLocal("nTable"))), c.call(prefix + "_zero", c.i32_add(c.getLocal("pTable"), c.i32_mul(c.getLocal("j"), c.i32_const(n8g)))), c.setLocal("j", c.i32_add(c.getLocal("j"), c.i32_const(1))), c.br(0))), c.setLocal("itBase", c.getLocal("pBases")), c.setLocal("itScalar", c.getLocal("pScalars")), c.setLocal("itCarry", c.i32_add(c.getLocal("pCarry"), c.i32_mul(c.getLocal("windowIdx"), c.getLocal("n")))), c.setLocal("i", c.i32_const(0)), c.block(c.loop(c.br_if(1, c.i32_eq(c.getLocal("i"), c.getLocal("n"))), c.if(c.i32_lt_s(c.getLocal("startBit"), c.getLocal("scalarBits")), c.setLocal("raw", c.call(fnName + "_getChunk", c.getLocal("itScalar"), c.getLocal("scalarSize"), c.getLocal("startBit"), c.getLocal("chunkSize"))), c.setLocal("raw", c.i32_const(0))), c.setLocal("d", c.i32_add(c.getLocal("raw"), c.i32_load8_u(c.getLocal("itCarry")))), c.if(c.i32_ge_s(c.getLocal("d"), c.getLocal("nTable")), c.setLocal("d", c.i32_sub(c.getLocal("d"), c.getLocal("full")))), c.if(c.i32_gt_s(c.getLocal("d"), c.i32_const(0)), [...c.setLocal("pIdxTable", c.i32_add(c.getLocal("pTable"), c.i32_mul(c.i32_sub(c.getLocal("d"), c.i32_const(1)), c.i32_const(n8g)))), ...c.call(opAdd, c.getLocal("pIdxTable"), c.getLocal("itBase"), c.getLocal("pIdxTable"))], c.if(c.i32_lt_s(c.getLocal("d"), c.i32_const(0)), [...c.setLocal("pIdxTable", c.i32_add(c.getLocal("pTable"), c.i32_mul(c.i32_sub(c.i32_const(-1), c.getLocal("d")), c.i32_const(n8g)))), ...c.call(opSub, c.getLocal("pIdxTable"), c.getLocal("itBase"), c.getLocal("pIdxTable"))])), c.setLocal("itScalar", c.i32_add(c.getLocal("itScalar"), c.getLocal("scalarSize"))), c.setLocal("itCarry", c.i32_add(c.getLocal("itCarry"), c.i32_const(1))), c.setLocal("itBase", c.i32_add(c.getLocal("itBase"), c.i32_const(n8b))), c.setLocal("i", c.i32_add(c.getLocal("i"), c.i32_const(1))), c.br(0))), c.setLocal("itB", c.i32_add(c.getLocal("pTable"), c.i32_mul(c.i32_sub(c.getLocal("nTable"), c.i32_const(1)), c.i32_const(n8g)))), c.call(prefix + "_copy", c.getLocal("itB"), c.getLocal("pr")), c.call(prefix + "_copy", c.getLocal("itB"), c.i32_const(accReduce)), c.setLocal("itB", c.i32_sub(c.getLocal("itB"), c.i32_const(n8g))), c.block(c.loop(c.br_if(1, c.i32_lt_u(c.getLocal("itB"), c.getLocal("pTable"))), c.call(prefix + "_add", c.i32_const(accReduce), c.getLocal("itB"), c.i32_const(accReduce)), c.call(prefix + "_add", c.getLocal("pr"), c.i32_const(accReduce), c.getLocal("pr")), c.setLocal("itB", c.i32_sub(c.getLocal("itB"), c.i32_const(n8g))), c.br(0))), c.i32_store(c.i32_const(0), c.getLocal("pTable")));
	}
	function buildMultiexp() {
		...
		f.addCode(c.call(prefix + "_zero", c.getLocal("pr")), c.if(c.i32_eqz(c.getLocal("n")), c.ret([])), c.setLocal("chunkSize", c.i32_load8_u(c.i32_clz(c.getLocal("n")), pTSizes)), c.if(c.i32_lt_s(c.getLocal("chunkSize"), c.i32_const(2)), c.setLocal("chunkSize", c.i32_const(2))), c.setLocal("nChunks", c.i32_add(c.i32_div_u(c.i32_sub(c.i32_shl(c.getLocal("scalarSize"), c.i32_const(3)), c.i32_const(1)), c.getLocal("chunkSize")), c.i32_const(1))), c.setLocal("nWin", c.i32_add(c.getLocal("nChunks"), c.i32_const(1))), c.setLocal("savedFree", c.i32_load(c.i32_const(0))), c.setLocal("pCarry", c.getLocal("savedFree")), c.i32_store(c.i32_const(0), c.i32_and(c.i32_add(c.i32_add(c.getLocal("savedFree"), c.i32_mul(c.getLocal("nWin"), c.getLocal("n"))), c.i32_const(3)), c.i32_const(-4))), c.call(fnName + "_recode", c.getLocal("pScalars"), c.getLocal("scalarSize"), c.getLocal("n"), c.getLocal("chunkSize"), c.getLocal("nChunks"), c.getLocal("pCarry")), c.setLocal("windowIdx", c.getLocal("nChunks")), c.block(c.loop(c.br_if(1, c.i32_lt_s(c.getLocal("windowIdx"), c.i32_const(0))), c.if(c.i32_eqz(c.call(prefix + "_isZero", c.getLocal("pr"))), [...c.setLocal("j", c.i32_const(0)), ...c.block(c.loop(c.br_if(1, c.i32_eq(c.getLocal("j"), c.getLocal("chunkSize"))), c.call(prefix + "_double", c.getLocal("pr"), c.getLocal("pr")), c.setLocal("j", c.i32_add(c.getLocal("j"), c.i32_const(1))), c.br(0)))]), c.call(fnName + "_chunk", c.getLocal("pBases"), c.getLocal("pScalars"), c.getLocal("scalarSize"), c.getLocal("pCarry"), c.getLocal("n"), c.getLocal("windowIdx"), c.getLocal("chunkSize"), c.i32_const(aux)), c.call(prefix + "_add", c.getLocal("pr"), c.i32_const(aux), c.getLocal("pr")), c.setLocal("windowIdx", c.i32_sub(c.getLocal("windowIdx"), c.i32_const(1))), c.br(0))), c.i32_store(c.i32_const(0), c.getLocal("savedFree")));
	}
	buildGetChunk();
	buildRecode();
	buildMutiexpChunk();
